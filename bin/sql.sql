DROP TABLE IF EXISTS `liangr_target`;
CREATE TABLE `liangr_target` (
...
CREATE TABLE `search_record` (
  ...
  `stock_name` VARCHAR(8) default '0',
  `fullup_cnt` DECIMAL(16) default '0',
  `liutongguben` DECIMAL(16,2) default '0',
  `liutonggudongbl` DECIMAL(16,2),
  `yeji` DECIMAL(16,2),
